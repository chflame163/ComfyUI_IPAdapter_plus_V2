...
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
"""
class IPAdapterUnifiedLoaderV2:
    def __init__(self):
        self.lora = None
...
class IPAdapterInsightFaceLoaderV2:
    @classmethod
    def INPUT_TYPES(s):
        return {
            "required": {
...
class IPAdapterBatchV2(IPAdapterAdvancedV2):
    def __init__(self):
...
class IPAdapterStyleCompositionV2(IPAdapterAdvancedV2):
    @classmethod
    def INPUT_TYPES(s):
        return {
            "required": {
...
class IPAdapterStyleCompositionBatchV2(IPAdapterStyleCompositionV2):
    def __init__(self):
        self.unfold_batch = True
...
class IPAdapterFaceIDV2(IPAdapterAdvancedV2):
    @classmethod
    def INPUT_TYPES(s):
        return {
            "required": {
...
class IPAAdapterFaceIDBatchV2(IPAdapterFaceIDV2):
    def __init__(self):
        self.unfold_batch = True

class IPAdapterFaceIDKolorsV2(IPAdapterAdvancedV2):
    @classmethod
    def INPUT_TYPES(s):
        return {
            "required": {
...
class IPAdapterTiledBatchV2(IPAdapterTiledV2):
    def __init__(self):
        self.unfold_batch = True
...
class IPAdapterEmbedsBatchV2(IPAdapterEmbedsV2):
    def __init__(self):
        self.unfold_batch = True

class IPAdapterMSV2(IPAdapterAdvancedV2):
    @classmethod
    def INPUT_TYPES(s):
        return {
            "required": {
...
class IPAdapterClipVisionEnhancerBatchV2(IPAdapterClipVisionEnhancerV2):
    def __init__(self):
        self.unfold_batch = True
...
class IPAdapterFromParamsV2(IPAdapterAdvancedV2):
    @classmethod
    def INPUT_TYPES(s):
        return {
            "required": {
...
class IPAdapterPreciseStyleTransferV2(IPAdapterAdvancedV2):
    @classmethod
    def INPUT_TYPES(s):
        return {
            "required": {
...
class IPAdapterPreciseStyleTransferBatchV2(IPAdapterPreciseStyleTransferV2):
    def __init__(self):
        self.unfold_batch = True

class IPAdapterPreciseCompositionV2(IPAdapterAdvancedV2):
    @classmethod
    def INPUT_TYPES(s):
        return {
            "required": {
...
class IPAdapterPreciseCompositionBatchV2(IPAdapterPreciseCompositionV2):
    def __init__(self):
        self.unfold_batch = True
...
class IPAdapterCombineEmbedsV2:
    @classmethod
    def INPUT_TYPES(s):
        return {"required": {
            "embed1": ("EMBEDS",),
...
class PrepImageForClipVisionV2:
    @classmethod
    def INPUT_TYPES(s):
        return {"required": {
            "image": ("IMAGE",),
...
class IPAdapterWeightsFromStrategyV2(IPAdapterWeightsV2):
    @classmethod
    def INPUT_TYPES(s):
        return {"required": {
...
class IPAdapterPromptScheduleFromWeightsStrategyV2():
    @classmethod
    def INPUT_TYPES(s):
        return {"required": {
            "weights_strategy": ("WEIGHTS_STRATEGY",),
...
class IPAdapterCombineWeightsV2:
    @classmethod
    def INPUT_TYPES(s):
        return {
        "required": {
...
class IPAdapterRegionalConditioningV2:
    @classmethod
    def INPUT_TYPES(s):
        return {"required": {
...
class IPAdapterCombineParamsV2:
    @classmethod
    def INPUT_TYPES(s):
        return {"required": {
...
NODE_CLASS_MAPPINGS = {
    # Main Apply Nodes
    "IPAdapterV2": IPAdapterSimpleV2,
    "IPAdapterAdvancedV2": IPAdapterAdvancedV2,
    "IPAdapterBatchV2": IPAdapterBatchV2,
    "IPAdapterFaceIDV2": IPAdapterFaceIDV2,
    "IPAdapterFaceIDKolorsV2": IPAdapterFaceIDKolorsV2,
    "IPAAdapterFaceIDBatchV2": IPAAdapterFaceIDBatchV2,
    "IPAdapterTiledV2": IPAdapterTiledV2,
    "IPAdapterTiledBatchV2": IPAdapterTiledBatchV2,
    "IPAdapterEmbedsV2": IPAdapterEmbedsV2,
    "IPAdapterEmbedsBatchV2": IPAdapterEmbedsBatchV2,
    ...
    "IPAdapterClipVisionEnhancerBatchV2": IPAdapterClipVisionEnhancerBatchV2,
    ...
    "IPAdapterPreciseCompositionV2": IPAdapterPreciseCompositionV2,
    "IPAdapterPreciseCompositionBatchV2": IPAdapterPreciseCompositionBatchV2,

    # Loaders
    "IPAdapterUnifiedLoaderV2": IPAdapterUnifiedLoaderV2,
    ...
    "IPAdapterCombineEmbedsV2": IPAdapterCombineEmbedsV2,
    "IPAdapterNoiseV2": IPAdapterNoiseV2,
    "PrepImageForClipVisionV2": PrepImageForClipVisionV2,
    "IPAdapterSaveEmbedsV2": IPAdapterSaveEmbedsV2,
    "IPAdapterLoadEmbedsV2": IPAdapterLoadEmbedsV2,
    "IPAdapterWeightsV2": IPAdapterWeightsV2,
    "IPAdapterCombineWeightsV2": IPAdapterCombineWeightsV2,
    "IPAdapterWeightsFromStrategyV2": IPAdapterWeightsFromStrategyV2,
    "IPAdapterPromptScheduleFromWeightsStrategyV2": IPAdapterPromptScheduleFromWeightsStrategyV2,
    "IPAdapterRegionalConditioningV2": IPAdapterRegionalConditioningV2,
    "IPAdapterCombineParamsV2": IPAdapterCombineParamsV2,
}
...
NODE_DISPLAY_NAME_MAPPINGS = {
    ...
    "IPAdapterFaceIDKolorsV2": "IPAdapter FaceID Kolors V2",
    ...
    "IPAdapterEmbedsBatchV2": "IPAdapter Embeds Batch V2",
    ...
    "IPAdapterClipVisionEnhancerBatchV2": "IPAdapter ClipVision Enhancer Batch V2",
    ...
    "IPAdapterPreciseCompositionV2": "IPAdapter Precise Composition V2",
    "IPAdapterPreciseCompositionBatchV2": "IPAdapter Precise Composition Batch V2",
    ...
    "IPAdapterNoiseV2": "IPAdapter Noise V2",
    ...
    "IPAdapterWeightsV2": "IPAdapter Weights V2",
    "IPAdapterWeightsFromStrategyV2": "IPAdapter Weights From Strategy V2",
    "IPAdapterPromptScheduleFromWeightsStrategyV2": "Prompt Schedule From Weights Strategy V2",
    "IPAdapterCombineWeightsV2": "IPAdapter Combine Weights V2",
    "IPAdapterRegionalConditioningV2": "IPAdapter Regional Conditioning V2",
    "IPAdapterCombineParamsV2": "IPAdapter Combine Params V2",
}